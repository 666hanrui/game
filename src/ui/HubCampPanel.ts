...
const CAMP_BUILDINGS: CampBuilding[] = [
  ...
  { id: "talents", name: "天赋祭坛", icon: "✦", kind: "temple", x: 218, y: 170, w: 188, h: 132, color: MODULE_ACCENT.talents, bossName: "天赋导师", line: "未来打开 MetaTalentPanel，读取 game.metaTalentState。", radius: 116 },
