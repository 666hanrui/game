...
const MARTIAL_SKILLS: Skill[] = [
  ...
  // 长枪
  { id: "spear_shadow", name: "枪芒", description: "长枪升级：刺击后额外释放远程枪芒；受雷纹或霜息天赋影响时，会自动触发对应联动。", school: "martial", weapon: "spear", rarity: "common", maxLevel: 5, mods: { projectileCount: 1 }, special: "spear_beam", tags: ["spear", "beam", "projectile_unlock"] },
  ...
  { id: "earthquake", name: "地裂", description: "钝器升级：重击后向前释放地裂波；受炎脉或霜息天赋影响时，会自动变成熔岩或冰裂联动。", school: "martial", weapon: "mace", rarity: "rare", maxLevel: 4, mods: { damage: 8 }, special: "earthquake", tags: ["mace", "ground", "shockwave"] },
